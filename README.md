...
> [!NOTE] 
> Если во время установки вы согласились добавить алиасы (чтобы работал zapret-utils или zapret-config) они станут доступны только в **новых** сессиях терминала. Чтобы использовать уже в открытом терминале, выполните:
>
>```bash
